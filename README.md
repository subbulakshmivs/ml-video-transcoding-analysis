...
This project focuses on analyzing and predicting video transcoding time using machine learning techniques and interactive data visualization. The study is based on the YouTube Video Transcoding dataset, which contains various video characteristics such as duration, bitrate, resolution, and codec.

The goal is to understand how these features influence transcoding time and to build a predictive model for performance analysis.
